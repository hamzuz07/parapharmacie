...
$icon = array(
		...
		'direct_import' 		=> 		'WooZone-icon-auto_importpr',
		'direct_import_cc' 		=> 		'WooZone-icon-auto_importpr',
		'noaws_import' 		=> 		'WooZone-icon-import-ext',
		'noaws_sync_widget'=> 		'WooZone-icon-import-ext',
		'addons' 				=> 		'WooZone-icon-add-on',
		'import_stats'			=> 		'WooZone-icon-add-on',
);
