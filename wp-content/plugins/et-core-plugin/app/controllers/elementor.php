...
final class Elementor extends Base_Controller {
    ...
    function register_categories( $elements_manager ) {
        $elements_manager->add_category(
            'eight_theme_general',
            array(
                'title' => __( 'XStore Widgets', 'xstore-core' ),
                'icon' => 'fa fa-plug',
            )
        );
    ...
    function etheme_elementor_lazy_load() {
	    ...
	    switch ($_POST['widgetType']) {
            case 'product-list':
	            ...
	            $posts = \ETC\App\Controllers\Elementor\General\Product_List::get_query($settings, array(
		            'ignore_sticky_posts' => 1,
		            'no_found_rows' => 1,
		    ...
		    case 'product-grid':
			    ...
			    $posts = \ETC\App\Controllers\Elementor\General\Product_Grid::get_query( $settings, array(
				    'ignore_sticky_posts' => 1,
				    'no_found_rows'       => 1,
				    'paged'               => $_POST['attr']['paged'],
				    'posts_per_page'      => $_POST['attr']['posts-per-page'],
		    ...
		    case 'posts-tabs':
			    ...
			    $posts = \ETC\App\Controllers\Elementor\General\Posts::get_query( $settings, array(
				    'ignore_sticky_posts' => 1,
				    'no_found_rows'       => 1,
				    'paged'               => $_POST['attr']['paged'],
				    'posts_per_page'      => $_POST['attr']['posts-per-page'],
		    ...
		    case 'posts-chess':
			    ...
			    $posts = \ETC\App\Controllers\Elementor\General\Posts_Chess::get_query( $settings, array(
				    'ignore_sticky_posts' => 1,
				    'no_found_rows'       => 1,
				    'paged'               => $_POST['attr']['paged'],
				    'posts_per_page'      => $_POST['attr']['posts-per-page'],
