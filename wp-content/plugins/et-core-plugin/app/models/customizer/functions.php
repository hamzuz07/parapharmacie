...
//		}
		...
		if ( class_exists('YITH_WCBK_Frontend')) {
			...
			switch ( $booking_form_position ) {
				case 'before_summary':
				case 'after_summary':
					add_action( 'etheme_woocommerce_template_single_add_to_cart', array( $instance, 'print_add_to_cart_template' ) );
					break;
				case 'after_title':
					add_action( 'etheme_woocommerce_template_single_add_to_cart', array( $instance, 'print_add_to_cart_template' ), 7 );
					break;
				case 'before_description':
					add_action( 'etheme_woocommerce_template_single_add_to_cart', array( $instance, 'print_add_to_cart_template' ), 15 );
					break;
				case 'after_description':
					add_action( 'etheme_woocommerce_template_single_add_to_cart', array( $instance, 'print_add_to_cart_template' ), 25 );
					break;
			}
		}
