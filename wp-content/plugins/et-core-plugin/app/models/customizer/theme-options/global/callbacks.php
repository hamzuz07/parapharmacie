...
function header_socials_callback() {
	...
	foreach ($element_options['header_socials_package_et-desktop'] as $key ) {
        ...
        <a href="<?php echo $key['social_url'] ?>" <?php echo $element_options['header_socials_target_et-desktop']; ?> <?php echo $element_options['header_socials_no_follow_et-desktop']; ?> data-tooltip="<?php echo $key['social_name']; ?>" title="<?php echo $key['social_name']; ?>">
			...
			<?php
			if ( isset( $key['social_icon'] ) && $key['social_icon'] != '' && isset( $et_social_icons[$element_options['header_socials_type_et-desktop']][$key['social_icon']] ) ) echo $et_social_icons[$element_options['header_socials_type_et-desktop']][$key['social_icon']];
...
//                    if ( is_cart() ) {
        ...
        <div class="et_column flex align-items-center justify-content-center <?php echo esc_attr($mob_panel_element_options['class']); ?>">
            <a <?php echo $link != '' ? 'href="'.$link.'"' : ''; ?> class="currentColor flex flex-col align-items-center <?php echo esc_attr($mob_panel_element_options['link_class']); ?>">
