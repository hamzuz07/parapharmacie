    ...
    add_filter( 'et/customizer/add/fields/cart-checkout-layout', function ( $fields ) use ($sep_style, $strings, $post_types, $box_models, $choices) {
		...
		$args = array(
            ...
            'cart_checkout_sales_booster'	=>	 array(
	            ...
	            'section'     => 'cart-checkout-layout',
	            'default'     => '<a href="'.admin_url('admin.php?page=et-panel-sales-booster').'" target="_blank" style="padding: 5px 7px; border-radius: var(--sm-border-radius); background: #222; color: #fff; text-decoration: none; box-shadow: none;">'.esc_html__('Sales Booster features', 'xstore-core').'</a>',
	            'active_callback' => array(
		            array(
			            'setting'  => 'cart_checkout_advanced_layout',
			            'operator' => '!=',
            ...
            'cart_checkout_logo_width_et-desktop'	=> array(
                ...
                'output' => array(
                    array(
                        ...
                        'element' => '.cart-checkout-advanced-layout .et_b_header-logo.et_element-top-level img',
                        'property' => 'width',
                        'units' => 'px'
                    )
                )
            ...
            'cart_checkout_main_header_wide_et-desktop'	=> array(
	            ...
	            'js_vars'     => array(
		            array(
			            'element'  => '.cart-checkout-advanced-layout .header-main-wrapper .header-main > .et-row-container',
            ...
            'cart_checkout_main_header_height_et-desktop'	=> array(
	            ...
	            'output'      => array(
		            array(
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout .header-main .et-wrap-columns, .header-main .widget_nav_menu .menu > li > a',
			            'property' => 'min-height',
			            'units' => 'px'
		            ),
		            array(
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout .header-main .widget_nav_menu .menu > li > a, .header-main #lang_sel a.lang_sel_sel, .header-main .wcml-dropdown a.wcml-cs-item-toggle',
		            ...
		            array(
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout .sticky-on .header-main .et-wrap-columns, .cart-checkout-advanced-layout #header[data-type="smart"].sticky-on .header-main .et-wrap-columns',
			            'property' => 'min-height',
			            'units' => 'px'
		            ),
		            array(
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout #header.sticky-on .header-main .widget_nav_menu .menu > li > a, .cart-checkout-advanced-layout #header[data-type="smart"].sticky-on .header-main .widget_nav_menu .menu > li > a,
									.cart-checkout-advanced-layout #header.sticky-on .header-main #lang_sel a.lang_sel_sel, .cart-checkout-advanced-layout #header[data-type="smart"].sticky-on .header-main #lang_sel a.lang_sel_sel,
									.cart-checkout-advanced-layout #header.sticky-on .header-main .wcml-dropdown a.wcml-cs-item-toggle, .cart-checkout-advanced-layout #header[data-type="smart"].sticky-on .header-main .wcml-dropdown a.wcml-cs-item-toggle',
			            'property' => 'line-height',
			            'units' => 'px'
		            ),
	            ),
            ...
            'cart_checkout_main_header_background_et-desktop'	=> array(
                ...
                'output'      => array(
                    array(
                        'context'	=> array('editor', 'front'),
                        'element' => '.cart-checkout-advanced-layout .header-main, .cart-checkout-advanced-layout .sticky-on .header-main',
                    ),
                ),
            ),
            ...
            'cart_checkout_main_header_box_model_et-desktop'	=>	 array(
	            ...
	            'output'	  => array(
		            array(
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout .header-main',
		            ),
		            array(
			            'choice' => 'margin-left',
			            'context'	=> array('editor', 'front'),
			            'element' => '.cart-checkout-advanced-layout .sticky-on .header-main',
	            ...
	            'transport' => 'postMessage',
	            'js_vars'   => array_merge(
		            box_model_output('.cart-checkout-advanced-layout .header-main'),
		            array(
			            array(
				            'choice' => 'margin-left',
				            'element' => '.cart-checkout-advanced-layout .sticky-on .header-main',
            ...
            'cart_checkout_footer_background_et-desktop'	=> array(
                ...
                'output'      => array(
                    array(
                        'context'	=> array('editor', 'front'),
                        'element' => '.cart-checkout-advanced-layout .footer',
                    ),
                ),
            ),
